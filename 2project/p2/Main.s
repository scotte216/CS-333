...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_consumerLock
	set	_Global_consumerLock,r1
	store	r1,[r14+-220]
!   Send message Init
	load	[r14+-220],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_producerLock
	set	_Global_producerLock,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_431 = &_Global_producerLock
	set	_Global_producerLock,r1
	store	r1,[r14+-44]
!   Send message Lock
	load	[r14+-44],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_438 = &_Global_producerLock
	set	_Global_producerLock,r1
	store	r1,[r14+-16]
!   Send message Unlock
	load	[r14+-16],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_460 = &_Global_consumerLock
	set	_Global_consumerLock,r1
	store	r1,[r14+-44]
!   Send message Lock
	load	[r14+-44],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_466 = &_Global_consumerLock
	set	_Global_consumerLock,r1
	store	r1,[r14+-20]
!   Send message Unlock
	load	[r14+-20],r1
...
!   _temp_611 = &_temp_610
	add	r14,-184,r1
	store	r1,[r14+-100]
!   _temp_611 = _temp_611 + 4
	load	[r14+-100],r1
	add	r1,4,r1
	store	r1,[r14+-100]
!   Next value...
!   NEW CLASS Constructor...
!   ZeroMemory: _temp_613 = zeros  (sizeInBytes=16)
	add	r14,-92,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
	store	r0,[r4+12]
!   _temp_613 = _P_Synch_Condition
	set	_P_Synch_Condition,r1
	store	r1,[r14+-92]
	mov	5,r1
	store	r1,[r14+-96]
_Label_615:
!   Data Move: *_temp_611 = _temp_613  (sizeInBytes=16)
	add	r14,-92,r5
	load	[r14+-100],r4
	load	[r5],r1
	store	r1,[r4]
...
!   _temp_612 = _temp_612 + -1
	...
	add	r1,-1,r1
	store	r1,[r14+-96]
!   if intNotZero (_temp_612) then goto _Label_615
	load	[r14+-96],r1
	cmp	r1,r0
	bne	_Label_615
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_609 = *_temp_616  (sizeInBytes=84)
	load	[r14+-72],r5
	load	[r14+-188],r4
	mov	21,r3
_Label_808:
...
!   _temp_619 = _temp_619 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-40]
!   _temp_620 = _temp_620 + -1
	load	[r14+-36],r1
	add	r1,-1,r1
	store	r1,[r14+-36]
!   if intNotZero (_temp_620) then goto _Label_621
	load	[r14+-36],r1
	cmp	r1,r0
	bne	_Label_621
!   Initialize the array size...
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_617 = *_temp_622  (sizeInBytes=24)
	load	[r14+-32],r5
	load	[r14+-68],r4
	load	[r5],r1
	store	r1,[r4]
...
!   Prepare Argument: offset=12  value=_temp_688  sizeInBytes=4
	load	[r14+-44],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_690  sizeInBytes=4
	load	[r14+-36],r1
	store	r1,[r15+8]
!   Send message Test
	load	[r14+-32],r1
...
!   _temp_718 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_717  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_713:
!   Perform the FOR-LOOP termination test
!   if p > _temp_718 then goto _Label_716		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_747 = _temp_748 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-72]
!   Move address of _temp_746 [_temp_747 ] into _temp_749
!     make sure index expr is >= 0
	load	[r14+-72],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-64]
!   Data Move: _temp_745 = *_temp_749  (sizeInBytes=4)
	load	[r14+-64],r1
	load	[r1],r1
	store	r1,[r14+-80]
!   if _temp_745 == 2 then goto _Label_742		(int)
	load	[r14+-80],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_742
...
!   _temp_752 = _temp_753 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-52]
!   Move address of _temp_751 [_temp_752 ] into _temp_754
!     make sure index expr is >= 0
	load	[r14+-52],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-44]
!   Data Move: _temp_750 = *_temp_754  (sizeInBytes=4)
	load	[r14+-44],r1
	load	[r1],r1
	store	r1,[r14+-60]
!   if _temp_750 == 2 then goto _Label_742		(int)
	load	[r14+-60],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_742
...
!   Data Move: _temp_755 = *_temp_757  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-40]
!   if _temp_755 != 1 then goto _Label_742		(int)
	load	[r14+-40],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_742
...
!   _temp_758 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_758 [p ] into _temp_759
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: *_temp_759 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-24],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_761 = &monitor
	...
	add	r1,48,r1
	store	r1,[r14+-16]
!   Move address of _temp_761 [p ] into _temp_762
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
